...
export default function ContactForm() {
  ...
  return <form className="contact-form" onSubmit={prepareEmail}>
    ...
    <label><span>What do you need?</span><select name="service" defaultValue="" required><option value="" disabled>Select a service</option><option>Instructional structure</option><option>Complete digital course</option><option>Complex learning programme</option><option>Fractional learning design support</option><option>Focused advice</option><option>I am not sure yet</option></select></label>

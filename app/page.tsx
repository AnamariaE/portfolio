  ...
  return <main>
    ...
    <section className="more-work">
      ...
      <div className="more-grid">
        ...
        <article><span>Recent learning strategy consultancy</span><h3>Ruralia Learning Pathway</h3><p>Co-designed with a senior learning-design colleague for an initiative supporting rural and Amazonian organisations in Peru. I led instructional strategy and content curation, using backward design and programme evidence to shape a flexible learning pathway and recommendations for future LMS implementation.</p><div className="mini-tag-row"><span>Backward design</span><span>Content curation</span><span>LMS planning</span><span>Rural learning</span></div></article>
      </div>
    </section>
